<?php $__env->startSection('title', 'TST White House Ltd.'); ?>
<?php $__env->startSection('meta_desc', 'TST White House Ltd. — Bangladesh\'s leading essential commodities and industrial construction materials trading company. Est. 2023.'); ?>

<?php $__env->startSection('content'); ?>


<link rel="stylesheet" href="<?php echo e(asset('css/hero-slider.css')); ?>">
...
<section class="section about-snap" id="about">
    <div class="container two-col">
        ...
        <div class="about-text fade-up" style="animation-delay:.15s">
            ...
            <a href="<?php echo e(route('about')); ?>" class="btn btn-primary" style="margin-top:24px">Read Our Story</a>
        </div>
    </div>
</section>
...
<section class="section section-gray" id="products">
    <div class="container">
        ...
        <div class="products-grid fade-up">
            ...
            <a href="<?php echo e($product['link']); ?>" class="product-card product-card--<?php echo e($product['color']); ?>">
                ...
                <div class="pc-body">
                    <h4 class="pc-name"><?php echo e($product['name']); ?></h4>
                    <p class="pc-desc"><?php echo e($product['desc']); ?></p>
                    <span class="pc-link">
                        Learn More
        ...
        <div style="text-align:center; margin-top:48px">
            <a href="<?php echo e(route('products')); ?>" class="btn btn-outline-dark">View All Products</a>
        </div>
...
<section class="section qa-snap">
    <div class="container two-col">
        <div class="qa-text fade-up">
            ...
            <a href="<?php echo e(route('quality')); ?>" class="btn btn-orange" style="margin-top:32px">Our QA Process</a>
        </div>
...
<section class="section section-gray" id="why">
    <div class="container">
        ...
        <div class="why-grid fade-up">
            ...
            <div class="why-card">
                <div class="wc-icon"><?php echo e($item['icon']); ?></div>
...
<section class="section jv-teaser">
    <div class="container two-col">
        ...
        <div class="jv-text fade-up" style="animation-delay:.15s">
            ...
            <a href="<?php echo e(route('partnership')); ?>" class="btn btn-primary" style="margin-top:28px">Learn About the Partnership</a>
        </div>
    </div>
</section>
...
<section class="cta-banner">
    <div class="container cta-inner">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="btn btn-white">Get in Touch Today</a>
    </div>
</section>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tst\resources\views/pages/home.blade.php ENDPATH**/ ?>